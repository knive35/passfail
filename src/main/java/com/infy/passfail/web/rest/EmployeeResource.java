...
import com.infy.passfail.web.rest.errors.BadRequestAlertException;
...
/**
 * REST controller for managing {@link com.infy.passfail.domain.Employee}.
 */
@RestController
@RequestMapping("/api")
@CrossOrigin(origins = "*", allowedHeaders = "*") public class EmployeeResource {
    ...
    private static final String ENTITY_NAME = "passfailEmployee";
